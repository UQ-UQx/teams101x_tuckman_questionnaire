...
<body>
		...
		$questions = array(
						...
						"Our team feels that we are all in it together and share responsibility for the team's success or failure.",
						...
						"Team members do not fully trust the other team members and closely monitor others who are working on specific tasks.",
						"The team leader ensures that we follow the procedures, do not argue, do not interrupt, and keep to the point.",
						"We enjoy working together; we have an enjoyable and productive time.",
						...
						"It seems as if little is being accomplished towards the project's goals.",
...
<p>Note: The Team Stage bars below will populate after you have submitted your responses.</p>
